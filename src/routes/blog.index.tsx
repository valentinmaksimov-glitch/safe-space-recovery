...
export const Route = createFileRoute("/blog/")({
  head: () => ({
    meta: [
      { title: "Блог | Валентин Максимов" },
      {
        name: "description",
        content:
          "Блог о повторяющихся сценариях, зависимом поведении и возвращении уверенности. Материалы на русском и иврите.",
      },
      { property: "og:title", content: "Блог | Валентин Максимов" },
      {
