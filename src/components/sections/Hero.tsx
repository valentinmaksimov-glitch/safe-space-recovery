...
export function Hero() {
  ...
  return (
    <section
      id="hero"
      // Мягкий фон (bg-stone-50) вместо стерильного белого
      className="min-h-screen flex items-center justify-center bg-stone-50 px-5 sm:px-8 py-24"
    >
      {/* Сетка на 2 колонки: текст и кнопки (start), фото (end) */}
      <div className="max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        ...
        <div className="flex flex-col text-start">
          ...
          {/* Кнопки одинаковой высоты и пропорций */}
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
            ...
            <a
              ...
              // Контурная кнопка, заливается цветом при наведении (hover:bg-ink hover:text-paper)
          ...
          <p className="text-xs tracking-widest text-ink/70 font-medium mt-6 leading-relaxed uppercase">
            {t("hero.trust")}
          </p>
        </div>

        {/* Правая колонка (Фотография и Факты) */}
