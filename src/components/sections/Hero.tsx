      ...
      <div className="max-w-3xl text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-3 text-xs tracking-[0.18em] uppercase text-ink border border-ink px-8 py-4 hover:bg-ink hover:text-paper transition-all duration-500 min-h-[44px]"
          >
