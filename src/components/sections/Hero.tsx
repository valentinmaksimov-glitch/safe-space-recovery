      ...
      <div className="max-w-3xl text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            ...
            className="cta-lift inline-flex items-center justify-center bg-accent text-paper text-xs tracking-[0.18em] uppercase px-8 py-4 min-h-[48px] rounded-md hover:bg-accent-hover"
          >
            {t("hero.cta_primary")}
          </button>
          ...
          <a
            ...
            className="cta-lift inline-flex items-center justify-center gap-3 text-xs tracking-[0.18em] uppercase text-ink border border-ink rounded-md px-6 py-4 whitespace-nowrap hover:bg-ink hover:text-paper min-h-[48px]"
          >
        ...
        <p className="text-xs text-muted mt-6 leading-relaxed inline-block border border-border bg-surface rounded-full px-4 py-2">
