        ...
        <div className="mt-10 flex flex-col items-center gap-8">
          <div className="flex items-center justify-center gap-5">
            <a
              ...
              aria-label="WhatsApp"
              className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-ink text-paper hover:bg-accent transition-all duration-500 min-h-[44px]"
            >
